...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('VacancyStatus', models.CharField(db_index=True, max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VacancyDate', models.DateTimeField()),
                ('VacancyGeo', models.CharField(max_length=300)),
                ('VacancyStatus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='working.vacancystatus')),
            ],
        ),
    ]
